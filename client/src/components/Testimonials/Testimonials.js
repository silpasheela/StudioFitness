    ...
    return (
        ...
        <div className="clientcard">
            ...
            <CardContent sx={{ backgroundColor: "#000", borderRadius: "15px" }}>
                ...
                "Fitness within is the cleanest and most organized gym I've ever
                seen! I have no words to say how wonderful they are! Domenic makes
                you feel super comfortable, Kaitlyn helps you eat better and
                healthy!"
                </Typography>
            </CardContent>
            </Card>
            ...
            <CardContent sx={{ backgroundColor: "#000", borderRadius: "15px" }}>
                ...
                "I will have been training at Fitness Within 3 years December
                2020. Since working out here I am stronger and in better shape
                than at any other time in my life. I find every class and every
                trainer are different.!"
                </Typography>
            </CardContent>
            </Card>
        </div>
