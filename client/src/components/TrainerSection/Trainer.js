        ...
        <div className="trainercard">
            ...
            <Card>
                ...
                <a
                    ...
                    <IconButton
                    sx={{ color: "#0077B7", backgroundColor: "#ededed" }}>
                    <LinkedInIcon />
                    </IconButton>
                </a>
                ...
                <a
                    ...
                    rel="noopener noreferrer">
                    <IconButton
                    sx={{ color: "#e95950", backgroundColor: "#ededed" }}>
                    <InstagramIcon />
                    </IconButton>
                </a>
                ...
                <a
                    ...
                    rel="noopener noreferrer">
                    <IconButton
                    sx={{ color: "#03A9F4", backgroundColor: "#ededed" }}>
                    <TwitterIcon />
                    </IconButton>
                </a>
                </CardActions>
            ...
            <Card>
                ...
                <Typography variant="body2" color="text.secondary">
                    A Zumba instructor is a fitness instructor who specializes in
                    teaching Zumba, which is a group fitness workout that blends a
                    variety of dance styles and Latin music.
                </Typography>
                </CardContent>
                <CardActions sx={{ paddingLeft: 14, marginBottom: 2 }}>
                <a
            ...
            <Card>
                ...
                <Typography variant="body2" color="text.secondary">
                    A yoga instructor is a certified yoga teacher who conducts
                    classes with groups of people which involves meditation and yoga
                    poses. Create lesson plans for yoga classes.
                </Typography>
                </CardContent>
                <CardActions sx={{ paddingLeft: 14, marginBottom: 2 }}>
                <a
