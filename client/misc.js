...
<TableCell align="right" style={{ ...tableCellStyle, color: (appointment?.isTrainerApproved) }}>
...
.banner-style-one{
  background-image: url(https://res.cloudinary.com/djd2rpgil/image/upload/v1696773683/gkfzrrjshubkcu8lnzbx.png);
...
@keyframes pulse1 {
  ...
  .main{
      ...
      background-image: url(https://mauiathletics.com/wp-content/uploads/2020/06/pesas-gym-png-2.png);
